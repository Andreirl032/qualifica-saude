  ...
  return (
    <div className="min-h-screen bg-base-200">
      <div className="navbar bg-base-700 flex py-5 relative">
        <Link
          to="/"
          className="btn btn-ghost text-xl ml-8"
        >
          <svg
          ...
          <div className="text-2xl">Qualifica Saúde</div>
        </Link>
        <h1 className="text-xl absolute left-1/2 transform -translate-x-1/2 text-gray-700">Bem vindo(a), {user.name}!</h1>
